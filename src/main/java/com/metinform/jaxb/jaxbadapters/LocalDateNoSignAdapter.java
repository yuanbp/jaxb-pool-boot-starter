...
public class LocalDateNoSignAdapter extends XmlAdapter<String, LocalDate> {

    private static final Logger LOG = LoggerFactory.getLogger(LocalDateNoSignAdapter.class);
